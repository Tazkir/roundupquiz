...
<template>
  <div class="w-full flex flex-col justify-center items-center p-10 gap-5">
    <div class="flex flex-col justify-center items-center gap-4 bg-gray-300/10 shadow-md rounded-lg px-10 py-5">
    ...
    <div class="px-5 py-4 w-full flex flex-wrap gap-10 justify-center items-center text-center">
      <div v-for="question in questionsWithAnswers" :key="question.id"
